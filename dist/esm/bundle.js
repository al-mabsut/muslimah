...
var prepareClickableWords = function prepareClickableWords(_ref3) {
  ...
  return words.map(function (word, index) {
    ...
    return isClickable ? h(Fragment, null, specialCharPosition == 0 ? "".concat(specialChars[0], " ") : '', h("span", {
...
var arrayToHtml = function arrayToHtml(arr) {
  ...
  var mainHtml = h("ul", null, arr.map(function (item) {
    return Array.isArray(item) ? _innerArrayToHtml(item) : item;
  }));
  return mainHtml;
};
...
var Content = function Content(_ref5) {
  ...
  return h("div", null, showInnerTitle && h("h3", null, heading), text && prepareTextElements({
    text: text,
    title: heading,
    settings: settings,
    terminologyClassName: terminologyClassName,
...
var PopUpModal = function PopUpModal(_ref) {
  ...
  }, h("h3", null, popUpModalWord, " ", "(".concat(terminologies[popUpModalWord.toLowerCase()].clarification.en, ")")), h("p", null, "Description/Explanation coming soon inshallah"), h("button", {
    className: popUpCloseButtonClassName || mainStyle.closeModalButton,
    onClick: function onClick() {
      return setDisplayPopUpModal(false);
    }
  }, typeof popUpCloseIcon === 'string' ? h("img", {
    src: popUpCloseIcon,
    alt: "popup-close"
  }) : popUpCloseIcon));
};
var Levels = function Levels(_ref2) {
  ...
  return h("div", {
    ...
    return RadioBoxComponent ? h(RadioBoxComponent, {
      id: lvl,
      value: lvl,
      checked: lvl === level,
  ...
  }), h("ul", null, h("li", null, LEVELS_CLARIFICATION[level])));
};
...
var Example = function Example(_ref4) {
  var settings = _ref4.settings,
    terminologyClassName = _ref4.terminologyClassName;
  return h("div", null, h("p", null, prepareTextElements({
...
var SettingsModal = function SettingsModal(_ref5) {
  ...
  return h("div", {
    ...
    onClick: hideModal
  }, typeof settingsCloseIcon === 'string' ? h("img", {
    src: settingsCloseIcon,
    alt: "settings-close"
  }) : settingsCloseIcon), h("h3", null, "Settings"), h("h4", null, "Levels:"), h(Levels, {
...
var Settings = function Settings(_ref6) {
  ...
  }, typeof settingsIcon === 'string' ? h("img", {
    src: settingsIcon,
    alt: "settings_icon"
  }) : settingsIcon), displaySettingsModal && h(SettingsModal, {
    settings: settings,
...
var Hidayah = function Hidayah() {
  ...
  var _useState3 = useState('Guidance'),
  ...
  return h("div", {
    ...
    terminologyClassName: terminologyClassName
  }), activeTab === 'Clarification' && h(Clarification, {
    action: action ? action : alternativeAction,
    text: content.additionalClarifications,
    showInnerTitle: showInnerTitle,
    settings: settings[userId] || DEFAULT_SETTINGS,
    terminologyClassName: terminologyClassName
  }), activeTab === 'Ramadan' && h(Ramadan, {
    action: action ? action : alternativeAction,
    text: content.ramadanClarifications,
    showInnerTitle: showInnerTitle,
    settings: settings[userId] || DEFAULT_SETTINGS,
    terminologyClassName: terminologyClassName
  }), activeTab === 'Marriage' && h(Marriage, {
    action: action ? action : alternativeAction,
...
export { Hayd, Indeterminate, Istihadah, MostLikelyHayd, MostLikelyIstihadah, MostLikelyTuhr, OngoingHayd, Tuhr };
